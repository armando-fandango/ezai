...
def n3(exp_id,
       ...
       testmode):
    """
    run the experiment after reading values from command line
    ...
    if testmode:
        print("Running in test mode... with autotune = {}".format(autotune))
    ...
    data_folder = os.path.join(exp_data,data_folder_str)
    ...
    if autotune:
        aml_conf = dict_util.DictObj({
            ...
            "runcount_limit": 3 if testmode else 20,
    ...
    # TODO: why 14400 ?
    n_rows = 100 if testmode else 14400
